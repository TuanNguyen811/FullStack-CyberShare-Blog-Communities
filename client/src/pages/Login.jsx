...
const GOOGLE_AUTH_URL = `${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/oauth2/authorize/google?redirect_uri=${encodeURIComponent(window.location.origin + '/oauth2/redirect')}`;
